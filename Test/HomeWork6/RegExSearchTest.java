...
public class RegExSearchTest {
    ...
    static Stream<Arguments> search(){
        ...
        return Stream.of(
                ...
                arguments(2, text, "Анны"),
                arguments(1, text, "гостей"),
                arguments(3, text, "виконт"),
                arguments(2, text, "Виконт")
        );
    }
}
